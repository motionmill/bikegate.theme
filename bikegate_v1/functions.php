...
register_nav_menus( array(
 		'secondary' => __( 'Top Menu', 'buddypress' ),
 		'primary' => __( 'Main Menu', 'buddypress' ),
		'tertiary' => __( 'Tags Menu (under Main Menu)', 'buddypress' ),
 	) );
}
...
register_sidebar( array(
	...
	'description' 	=> 'Beheer hier wat zichtbaar is in de sidebar van de community',
	'before_widget' => '<div id="%1$s" class="widget %2$s">',
	'after_widget' 	=> '</div></div>',
	'before_title' 	=> '<h3>',
	'after_title' 	=> '</h3><div class="padder">'
...
register_sidebar( array(
	'name' 			=> 'Multimedia Slider Middle',
	'description' 	=> 'Hier komt de slider met featured posts of laatste mediafiles',
	'before_widget' => '<div id="%1$s" class="widget %2$s">',
	'after_widget' 	=> '</div>',
	'before_title'	=> '<h3>',
	'after_title' 	=> '</h3>'
...
register_sidebar( array(
	'name' 			=> 'Center Ads',
	'description' 	=> 'Hier komt de code voor de partner buttons',
	'before_widget' => '<div id="%1$s" class="widget %2$s">',
	'after_widget' 	=> '</div>',
	'before_title'	=> '<h3>',
	'after_title' 	=> '</h3>'
...
register_sidebar( array(
	'name' 			=> 'Bottom Content',
	'description' 	=> 'Hier is ruimte om extra newsfeeds te tonen in smalle kolommen',
	'before_widget' => '<div id="%1$s" class="widget %2$s">',
	'after_widget' 	=> '</div>',
	'before_title'	=> '<h3>',
	'after_title' 	=> '</h3>'
...
register_sidebar( array(
	'name' 			=> 'Footer',
	'description' 	=> 'Widget zone helemaal onderaan de webpagina',
	'before_widget' => '<div id="%1$s" class="widget %2$s">',
	'after_widget' 	=> '</div>',
	'before_title'	=> '<h3>',
	'after_title' 	=> '</h3>'
